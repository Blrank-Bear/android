...
public final class NetworkModule_ProvideRetrofitFactory implements Factory<Retrofit> {
  ...
  public NetworkModule_ProvideRetrofitFactory(Provider<OkHttpClient> okHttpClientProvider,
      Provider<Moshi> moshiProvider, Provider<NetworkConfig> configProvider) {
  ...
  @Override
  public Retrofit get() {
    return provideRetrofit(okHttpClientProvider.get(), moshiProvider.get(), configProvider.get());
  }
  ...
  public static NetworkModule_ProvideRetrofitFactory create(
    ...
    return new NetworkModule_ProvideRetrofitFactory(okHttpClientProvider, moshiProvider, configProvider);
  }

  public static Retrofit provideRetrofit(OkHttpClient okHttpClient, Moshi moshi,
      NetworkConfig config) {
    return Preconditions.checkNotNullFromProvides(NetworkModule.INSTANCE.provideRetrofit(okHttpClient, moshi, config));
  }
}
