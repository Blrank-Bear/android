...
public class RegisterRequestJsonAdapter(
  ...
  public override fun fromJson(reader: JsonReader): RegisterRequest {
    ...
    while (reader.hasNext()) {
      when (reader.selectName(options)) {
        ...
        2 -> password = stringAdapter.fromJson(reader) ?: throw Util.unexpectedNull("password",
            "password", reader)
        3 -> passwordConfirm = stringAdapter.fromJson(reader) ?:
            throw Util.unexpectedNull("passwordConfirm", "password_confirm", reader)
        -1 -> {
    ...
    return RegisterRequest(
        ...
        passwordConfirm = passwordConfirm ?: throw Util.missingProperty("passwordConfirm",
            "password_confirm", reader)
    )
  }
  ...
  public override fun toJson(writer: JsonWriter, value_: RegisterRequest?): Unit {
    ...
    writer.name("password_confirm")
    stringAdapter.toJson(writer, value_.passwordConfirm)
    writer.endObject()
  }
}
